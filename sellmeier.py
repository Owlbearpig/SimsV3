...
resolution = 1
matpath_slow = Path('material_data/quartz_m_slow2.csv')
matpath_fast = Path('material_data/quartz_m_fast2.csv')
...
ref_ind = np.array(df[ref_ind_key])[data_slice]
...
print(fit(sellmeier, [B1, B2, B3, C1, C2, C3], data, x=wls))
